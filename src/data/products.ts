...
export const PRODUCTS: Product[] = [
  {
    id: "organic-cones",
    name: "Sojat Organic Cones",
    price: "₹18",
    badges: ["New Product", "100% Organic"],
    category: "cones",
    image: "/products/henna-cones.png",
    tagline: "Triple-sifted Rajasthani henna paste with pure eucalyptus oil",
    description:
      "Handcrafted using 100% pure organic Rajasthani henna powder, pure high-eucalyptol oil, and cane sugar syrup for a silky smooth flow and rich mahogany stain that lasts up to 2 weeks.",
    rating: 4.9,
    reviewsCount: 142,
    isFeatured: true,
  },
  {
    id: "aftercare-balm",
    name: "Heal & Glow Henna Balm",
    price: "₹28",
    badges: ["Best Seller", "Aftercare"],
    category: "care",
    image: "/products/aftercare-balm.png",
    tagline:
      "Nourishing botanical blend to lock in and deepen your mehndi stain",
    description:
      "All-natural balm made with organic beeswax, sweet almond oil, and therapeutic essential oils. Creates an impermeable moisture barrier that deepens the stain oxidation process.",
    rating: 5.0,
    reviewsCount: 98,
    isFeatured: true,
  },
  ...
  },
  {
    ...
    price: "₹75",
    badges: ["New Product", "Luxury Edition"],
    category: "kits",
    image: "/products/bridal-kit.png",
    tagline:
      "Complete ceremonial bridal suite with artisan cones, balm & gold keepsake box",
    description:
      "The ultimate ceremonial package featuring 6 fresh bridal cones, luxury aftercare balm, sealant spray, design guide booklet, and an engraved gold-foiled presentation keepsake box.",
    rating: 5.0,
    reviewsCount: 64,
    isFeatured: true,
  },
  {
    ...
    name: "Artisan Fine-Tip Cones",
    price: "₹24",
    badges: ["Artisan Tool", "Ultra Fine"],
    category: "cones",
    image: "/products/henna-cones.png",
    tagline: "Micro-pinhole cones engineered for intricate bridal lace details",
    description:
      "Laser-cut ultra-fine tips calibrated specifically for microscopic line work, intricate netting, and delicate floral shading without hand fatigue.",
    rating: 4.8,
    reviewsCount: 53,
    isFeatured: false,
  },
  ...
  },
  {
    ...
    name: "Ceremonial Mehndi Trunk",
    price: "₹120",
    badges: ["Signature", "Limited Batch"],
    category: "kits",
    image: "/products/bridal-kit.png",
    tagline: "Handcrafted collector's gift trunk for grand bridal celebrations",
    description:
      "An heirloom-worthy wooden trunk wrapped in artisan cloth containing 12 fresh cones, 2 jars of aftercare balm, applicator accessories, and golden sealing ribbons.",
    rating: 5.0,
    reviewsCount: 29,
    isFeatured: false,
  },
