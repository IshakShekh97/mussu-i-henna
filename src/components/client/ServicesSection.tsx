...
const SERVICES: ServiceItem[] = [
  {
    ...
    detail: "Bespoke Kolka & Shankha-Pola",
    bengali: "বাঙালি রাজকীয় ব্রাইডাল",
    image: "/services/bengali-bridal.jpg",
    link: "/booking?occasion=bridal",
  },
  {
    id: "guest_party",
    title: "Guest / Party Mehendi",
    category: "Celebratory Troupe",
    detail: "Borjatri, Sakhis & Family Troupe",
    bengali: "অতিথি ও ব্রাইডাল পার্টি",
    image: "/services/bou-bhat.jpg",
    link: "/booking?occasion=guest_party",
  },
  {
    id: "festive_occasion",
    title: "Festive / Occasion Mehendi",
    category: "Cultural Heritage",
    detail: "Gaye Holud, Pujo & Cultural Rituals",
    bengali: "উৎসব ও স্পেশাল অনুষ্ঠান",
    image: "/services/gaye-holud.jpg",
    link: "/booking?occasion=festive_occasion",
  },
  {
    id: "custom",
    title: "Custom Mehendi Occasion",
    category: "Bespoke Request",
    detail: "Personalized Vision & Custom Timeline",
    bengali: "আপনার নিজস্ব কাস্টম অনুষ্ঠান",
    image: "/services/kolka-studio.jpg",
    link: "/booking?occasion=custom",
  },
];
