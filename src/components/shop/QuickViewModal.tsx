          ...
          >
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <Button
                ...
                className="rounded-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-6 py-3 text-xs sm:text-sm uppercase tracking-wider shadow-lg flex items-center gap-2 cursor-pointer h-auto"
              >
